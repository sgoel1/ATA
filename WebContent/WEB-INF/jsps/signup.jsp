	...
	<div id="backgroundborder1">
		...
		<form action="adduserprofile" method="get">
			<table>
				...
				<tr>
					<td>Date Of Birth</td>
					<td><input type="date" name="dateofbirth" class="textbox1" /></td>
				<tr>
					<td>Gender</td>
				...
				<tr>
					<td>Street</td>
					<td><input type="text" name="street" class="textbox1" /></td>
				<tr>
					<td>City</td>
					<td><input type="text" name="city" class="textbox1" /></td>
				<tr>
					<td>State</td>
					<td><input type="text" name="state" class="textbox1" /></td>
				<tr>
					<td>Pincode</td>
					<td><input type="text" name="pincode" class="textbox1" /></td>
				<tr>
					<td>Mobile</td>
					<td><input type="text" name="mobileNo" class="textbox1" /></td>
				<tr>
					<td>Email</td>
					<td><input type="email" name="emailID" class="textbox1" /></td>
				<tr>
					<td>Password</td>
